...
function NewComment({ setShowCommentForm, post, setCommentedOn, setComments }) {
  ...
  const handleAddComment = async (e) => {
    ...
    try {
      const res = await axios.put(`/posts/comment/${post._id}`, body)
  ...
  return (
    <div className="new-comment-parent pb-2">
      <form className="comment-form" onSubmit={handleAddComment}>
        ...
        {error && <span className="text-danger text-center">{error.msg}</span>}
